    ...
    return(
        <section className="about">
            ...
            <div className="aboutImage">
                <img src="https://images.unsplash.com/photo-1523800503107-5bc3ba2a6f81?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="grey laptop in a window at night, next to a dim lightbulb" />
            </div>
        </section>
    )
}
